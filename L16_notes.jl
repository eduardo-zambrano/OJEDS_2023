...
# # clustering algorithm. Here, we used k-means clustering, as in Chapter 4 of our textbook, with k=5.
"""
...
function codist(S)
    n = size(S)[2] 
    D =  sqrt.(0.5* (ones(size(n)) .- cor(S)))
    return D
end

# https://miro.medium.com/v2/resize:fit:720/format:webp/1*Jk-Nxn1-L5vwCymaVRYIoA.png
